        ...
        <Navbar className="nav" collapseOnSelect expanded={expanded} expand="lg" bg="dark" variant="dark">
            ...
            <Navbar.Collapse id="responsive-navbar-nav" onClick={() => setTimeout(() => {setExpanded(false)}, 150)}>
                <Nav className="mr-auto">
                    ...
                    <Nav.Link className="d-lg-none" href="https://github.com/roberthdg/FIFA-Ultimate-Team-Draft-ReactJS">Github Project</Nav.Link>
                </Nav>
                            
                <Nav.Link href="https://github.com/roberthdg/FIFA-Ultimate-Team-Draft-ReactJS">
